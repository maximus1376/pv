<?php
define('BOT_TOKEN', '308698461:AAEp2JH87OWH9_ZRzPDCzp-7c5sHpGxtOoY');
...
لطفا پیام ندهید🖕" ,"parse_mode" =>"HTML"));	
	...
	apiRequest("sendMessage", array('chat_id' => $chat_id, "text" => "🗣/n dev buy @Hosi_dark پیام شما ارسال شد. " ,"parse_mode" =>"HTML"));
